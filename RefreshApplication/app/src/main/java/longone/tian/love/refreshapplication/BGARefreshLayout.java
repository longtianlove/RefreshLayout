...
public class BGARefreshLayout extends LinearLayout {
    ...
    private ChinaHRImplRefreshViewHolder mRefreshViewHolder;
    /**
    ...
    public void setRefreshViewHolder(ChinaHRImplRefreshViewHolder refreshViewHolder) {
    ...
    private boolean handleActionMove(MotionEvent event) {
        ...
        if (refreshDiffY > 0 && shouldHandleRefresh() && isCustomHeaderViewCompleteVisible()) {
            ...
            if (paddingTop > 0 && mCurrentRefreshStatus != RefreshStatus.RELEASE_REFRESH) {
                ...
                mRefreshViewHolder.resetHeaderState();//龙-----先进行刷新
    ...
    private void hiddenRefreshHeaderView() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                int paddingTop = (int) animation.getAnimatedValue();
                mWholeHeaderView.setPadding(0, paddingTop, 0, 0);
                Log.e("mWholeHeaderView",paddingTop+"");
...
//            }
//        }
        if(mIsLoadingMore) {//龙---添加加载更多判断
            mRefreshViewHolder.endLoadingMore();
            mIsLoadingMore=false;
        }
    }
